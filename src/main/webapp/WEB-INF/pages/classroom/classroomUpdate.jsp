...
<head>
    ...
    <script type="text/javascript">
        ...
        function doSubmit(){
            var bool = window.confirm("即将进行修改教室表数据,确定修改?");
            if(bool){
...
<div class="submenu">
    <ul>
        ...
        <li><a href="/web/classroom/update.htm" class="selected">课表修改</a></li>
...
<div class="center_content">
    ...
    <div id="right_wrap">
        ...
        <div id="right_content">
            <form id="form1" name="form1" action="/web/classroom/update.htm" method="POST"/>
                <h2>教室信息更新</h2>
                <table style="padding: 10px">
                    <tr>
                        ...
                        <td>
                            <div class="form_row_td">
                                <label>最大人数</label>
                                <input class="form_input_tab" type="text" name="classroom_max_man" />
                            </div>
                        </td>
                        <td>
                            <div class="form_row_td">
                                <label>地点Id</label>
                                <input class="form_input_tab" type="text" name="loc_id" />
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form_row_td">
                                <label>教室状态</label>
                                <input class="form_input_tab" type="text" name="curr_status" />
                            </div>
                        </td>
                        <td>
                            <div class="form_row_td">
                                <label>状态标识</label>
                                <input class="form_input_tab" type="text" name="curr_status_code" />
                            </div>
                        </td>
                        <td>
                            <div class="form_row_td">
                                <label>教室类型</label>
                                <input class="form_input_tab" type="text" name="classroom_type" />
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form_row_td">
                                <label>课程01串</label>
                                <input class="form_input_tab" type="text" name="class_val" />
                            </div>
                        </td>
                        <td>
                            <div class="form_row_td">
                        ...
                        <td>
                            <input class="form_submit" type="submit" value="更新" onclick="doSubmit()" />
                        </td>
                    </tr>
                </table>
            </form>
            <span id="errorMsg" style="color: red">${errorMsg}</span><span id="infoMsg" style="color: green">${infoMsg}</span>
            <form action="/web/classroom/update.htm" method="get"/>
            <h2>教室查询</h2>
            <table style="padding: 10px">
                <tr>
                    <td>

...
<div id="panelwrap">
    ...
    <div class="submenu">
        <ul>
            <li><a href="/web/classroom/search.htm" class="selected">课表查询</a></li>
    ...
    <div class="center_content">
        <form action="/web/classroom/search.htm" method="post"/>
        <div id="right_wrap">
                ...
                <table style="padding: 10px">
                    <tr>
                        <td>
                            <div class="form_row">
                                <label>教室名称</label>
                                <input class="form_input_tab" type="text" name="classroom_name" /><span id="errorMsg" style="color: red">${errorMsg}</span><span id="infoMsg" style="color: green">${infoMsg}</span>
                            </div>
                        </td>
                        <td>

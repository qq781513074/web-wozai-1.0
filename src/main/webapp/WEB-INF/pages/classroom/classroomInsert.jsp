...
<div class="submenu">
    <ul>
        ...
        <li><a href="/web/classroom/insert.htm" class="selected">课表添加</a></li>
...
<div id="right_wrap">
    ...
    <div id="right_content">
        <form id="form1" name="form1" action="/web/classroom/insert.htm" method="POST"/>
        <h2>教室信息更新</h2>
        <table style="padding: 10px">
            ...
            <tr>
                ...
                <td>
                    <input class="form_submit" type="submit" value="新增" onclick="doSubmit()" />
                </td>
            </tr>
        </table>
        </form>
        <span id="errorMsg" style="color: red">${errorMsg}</span><span id="infoMsg" style="color: green">${infoMsg}</span>
        <form action="/web/classroom/insert.htm" method="get"/>
        <h2>教室查询</h2>
        <table style="padding: 10px">
            <tr>
                <td>
